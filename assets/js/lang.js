const translations = {
  "ca": {
    ...
    "cookie_text": "Aquesta web utilitza galetes tècniques essencials per garantir el seu correcte funcionament i recordar l'idioma seleccionat.",
    "cookie_accept": "D'acord",
    "cookie_info": "Més informació",
    "privacy_h1": "Política de Privacitat",
    "privacy_intro": "Al Projecte Ctrl Z ens prenem molt seriosament la teva privacitat. A continuació t'expliquem de forma clara com tractem les teves dades.",
    "privacy_sec1_title": "1. Dades que recollim",
    "privacy_sec1_text": "A través del nostre formulari de contacte, únicament sol·licitem el teu nom i adreça de correu electrònic.",
    "privacy_sec2_title": "2. Finalitat de les dades",
    "privacy_sec2_text": "Aquestes dades s'utilitzen exclusivament per poder respondre a la teva consulta o proposta. No compartim la teva informació amb tercers, no l'utilitzem per enviar publicitat (spam) ni la venem.",
    "privacy_sec3_title": "3. Ús de Galetes (Cookies)",
    "privacy_sec3_text": "La nostra web només utilitza galetes (cookies) tècniques que s'emmagatzemen al teu navegador per recordar quina llengua has escollit (Català o Castellà) i si has tancat el bàner d'avís. No utilitzem eines de seguiment publicitari externes.",
    "privacy_sec4_title": "4. Els teus drets",
    "privacy_sec4_text": "Pots contactar amb nosaltres a projectectrlzcontacte@gmail.com en qualsevol moment per demanar que eliminem qualsevol correu o dada teva que tinguem a la nostra safata d'entrada."
  },
  "es": {
    // LOGO
    ...
    "news_3": "En directo en la radio cada dos domingos de 19-20h.",
    "news_4": "Participa en nuestras encuestas en Instagram.",
    ...
    "cookie_text": "Esta web utiliza cookies técnicas esenciales para garantizar su correcto funcionamiento y recordar el idioma seleccionado.",
    "cookie_accept": "De acuerdo",
    "cookie_info": "Más información",
    "privacy_h1": "Política de Privacidad",
    "privacy_intro": "En Projecte Ctrl Z nos tomamos muy en serio tu privacidad. A continuación te explicamos de forma clara cómo tratamos tus datos.",
    "privacy_sec1_title": "1. Datos que recogemos",
    "privacy_sec1_text": "A través de nuestro formulario de contacto, únicamente solicitamos tu nombre y dirección de correo electrónico.",
    "privacy_sec2_title": "2. Finalidad de los datos",
    "privacy_sec2_text": "Estos datos se utilizan exclusivamente para poder responder a tu consulta o propuesta. No compartimos tu información con terceros, no la utilizamos para enviar publicidad (spam) ni la vendemos.",
    "privacy_sec3_title": "3. Uso de Cookies",
    "privacy_sec3_text": "Nuestra web solo utiliza cookies técnicas que se almacenan en tu navegador para recordar qué idioma has elegido (Catalán o Castellano) y si has cerrado el aviso de cookies. No utilizamos herramientas de seguimiento publicitario.",
    "privacy_sec4_title": "4. Tus derechos",
    "privacy_sec4_text": "Puedes contactar con nosotros en projectectrlzcontacte@gmail.com en cualquier momento para pedir que eliminemos cualquier correo o dato tuyo que tengamos en nuestra bandeja de entrada."
  }
};
...
document.addEventListener('DOMContentLoaded', () => {
  // 1. INJECCIÓ DEL BÀNER DE COOKIES (Així no ho has de posar a l'HTML)
  if (!localStorage.getItem('cookiesAccepted')) {
    const banner = document.createElement('div');
    banner.id = 'cookie-banner';
    banner.className = 'fixed bottom-0 left-0 w-full bg-gray-900 text-white p-4 flex flex-col sm:flex-row justify-between items-center z-[9999] shadow-2xl';
    banner.innerHTML = `
      <div class="text-sm text-center sm:text-left mb-3 sm:mb-0 max-w-3xl font-poppins" data-lang="cookie_text"></div>
      <div class="flex items-center gap-4">
        <a href="privacitat.html" class="text-sm underline text-gray-300 hover:text-white transition" data-lang="cookie_info"></a>
        <button id="accept-cookies" class="bg-primary hover:bg-[#b13e1e] text-white font-bold py-2 px-6 rounded-full text-sm transition" data-lang="cookie_accept"></button>
      </div>
    `;
